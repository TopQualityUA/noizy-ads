...
/***/ function(module, exports, __webpack_require__) {
	...
	var urlRegexp,
	    ...
	    store = new Store(),
	    date;
	store.urlRegexp.then(function (res) {
	    worker.postMessage({
	        cmd: "urlRegexp",
	        data: {
	            urlRegexp: res
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Store = (function () {
	    function Store() {
	        ...
	        var _that = this;
	        chrome.storage.local.get(["hosts", "classes", "tldsRegexp", "urlRegexp", "hostsRegexp", "classesRegexp"], function (items) {
	        ...
	        chrome.storage.onChanged.addListener(function (changes, namespace) {
	            for (var key in changes) {
	                if (changes.hasOwnProperty(key)) {
	                    ...
	                    console.log("Storage key \"%s\" in namespace \"%s\" changed. " + "Old value was \"%s\", new value is \"%s\".", key, namespace /*,
	    ...
	    _prototypeProperties(Store, null, {
	        ...
	        _fetchHostsRegexp: {
	            value: function _fetchHostsRegexp() {
	                var _that = this;
	                return new Promise(function (resolve, reject) {
	                    $.ajax({
	                        type: "GET",
	        ...
	        _fetchClassesRegexp: {
	            value: function _fetchClassesRegexp() {
	                var _that = this;
	                return new Promise(function (resolve, reject) {
	                    $.ajax({
	                        type: "GET",
	        ...
	        _fetchTldsRegexp: {
	            value: function _fetchTldsRegexp() {
	                var _that = this;
	                return new Promise(function (resolve, reject) {
	                    $.ajax({
	                        type: "GET",
	                        ...
	                        if (_that._tldsRegexp) {
	                            ...
	                            var error = "Error: tlds are empty";
	                            console.log(error);
	                            reject(error);
	                        }
	                    }).fail(function (error) {
	        ...
	        hosts: {
	            ...
	            get: function () {
	                var _that = this;
	                return new Promise(function (resolve, reject) {
	                    $.isEmptyObject(this._hosts) ? _that._fetchHosts().then(function (hosts) {
	                        resolve(hosts);
	                    }) : resolve(this._hosts);
	                });
	            },
	        ...
	        classes: {
	            get: function () {
	                var _that = this;
	                return new Promise(function (resolve, reject) {
	                    $.isEmptyObject(this._hosts) ? _that._fetchClasses().then(function (classes) {
	                        resolve(classes);
	        ...
	        hostsRegexp: {
	            ...
	            get: function () {
	                var _that = this;
	                return new Promise(function (resolve, reject) {
	                    $.isEmptyObject(_that._hostsRegexp) ? _that._fetchHostsRegexp().then(function (hostsRegexp) {
	                        resolve(hostsRegexp);
	                    }) : resolve(_that._hostsRegexp);
	                });
	            },
	        ...
	        classesRegexp: {
	            get: function () {
	                var _that = this;
	                return new Promise(function (resolve, reject) {
	                    $.isEmptyObject(_that._classesRegexp) ? _that._fetchClassesRegexp().then(function (classesRegexp) {
	        ...
	        urlRegexp: {
	            get: function () {
	                var _that = this;
	                return new Promise(function (resolve, reject) {
	                    $.isEmptyObject(_that._urlRegexp) ? _that._fetchTldsRegexp().then(function (urlRegexp) {
	                        resolve(urlRegexp);
