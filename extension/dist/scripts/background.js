...
/***/ function(module, exports, __webpack_require__) {
	...
	var Store = _interopRequire(__webpack_require__(4));
...
/***/ function(module, exports, __webpack_require__) {
	...
	var $ = jquery;
	var _urlRegexp, _hostsRegexp, _classesRegexp, _hosts, _tlds, _classes, _fetchHosts, _fetchClasses, _fetchTlds, _buildHostsRegexp, _buildClassesRegexp, _buildUrlRegexp;
	    ...
	    return new Promise(function (resolve, reject) {
	        chrome.storage.local.get("hosts", function (item) {
	            if ($.isEmptyObject(item.hosts)) {
	                ...
	                var _hostsRegexpBody = Array.prototype.slice.call(item.hosts).map(function (el) {
	...
	_buildClassesRegexp = function () {
	    chrome.storage.local.get("classes", function (item) {
	        if ($.isEmptyObject(item.classes)) {
	            ...
	            var _classesRegexpBody = Array.prototype.slice.call(item.classes).map(function (el) {
	                return ".*" + el.name.replace(".", "\\.") + ".*";
	            }).join("|");
	...
	var Store = (function () {
	    function Store() {
	        ...
	        chrome.storage.local.get(["hosts", "classes", "tlds", "urlRegexp", "hostsRegexp", "classesRegexp"], function (items) {
	            // Notify that we saved.
	            if (!items.hosts) {
	                _fetchHosts();
	            } else {
	    ...
	    _prototypeProperties(Store, null, {
	        ...
	        getHost: {
	            value: function getHost(hostKey) {
	                var result = "";
	        ...
	        getClass: {
	            value: function getClass(classKey) {
	                var result = "";
	        ...
	        getHostsRegexp: {
	            value: function getHostsRegexp(classKey) {
	                if (!_hostsRegexp) {
	                    _buildHostsRegexp();
	                }
	                return _hostsRegexp;
	        ...
	        getClassesRegexp: {
	            value: function getClassesRegexp(classKey) {
	                if (!_classesRegexp) {
	                    _buildClassesRegexp();
	                }
